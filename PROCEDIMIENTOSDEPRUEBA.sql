...
(IN CAMION INT, IN DIAD DATE, IN HORAD TIME, IN VOLTAJED DOUBLE, IN BATERIAD INT, IN TEMPERATURAD DOUBLE, IN EST BOOLEAN)
BEGIN
	INSERT INTO DETALLE_CAMIONES(CAM_ID, DIA, HORA, VOLTAJE, BATERIA, TEMPERATURA, EST_DC)
    VALUES(CAMION, DIAD, HORAD, VOLTAJED, BATERIAD, TEMPERATURAD, EST);
END //
...
CALL AGREGAR_CAMIONES('ABC-002', 2, 3, 1);
